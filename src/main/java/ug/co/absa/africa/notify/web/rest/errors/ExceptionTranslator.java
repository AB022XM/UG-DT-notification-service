package ug.co.absa.africa.notify.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.notify.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.notify.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.notify.service.InvalidPasswordException
